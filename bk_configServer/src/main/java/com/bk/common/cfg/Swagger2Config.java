...
public class Swagger2Config
{
	...
	/*
	 * @Bean public Docket testApi() { return new
	 * Docket(DocumentationType.SWAGGER_2).groupName("test2")
	 * .genericModelSubstitutes(DeferredResult.class).apiInfo(new
	 * ApiInfoBuilder().title("testApi").description("testApitestApitestApi").
	 * version("1.0").build()).select()
	 * .apis(Swagger2Config.basePackage(basePackage)).paths(PathSelectors.any()).
	 * build(); }
	 */
